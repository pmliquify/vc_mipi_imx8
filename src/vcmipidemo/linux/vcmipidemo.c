...
I32  convert_16bit_to_image(image *imgOut, char *bufIn, I32 v4lDx, I32 v4lDy, I32 v4lPitch, I32 maxBits, int bitShift);
I32  convert_srggb10_and_debayer_image(image *imgOut, char *bufIn, U32 pixelformat, I32 v4lDx, I32 v4lDy, I32 v4lPitch, I32 maxBits, int bitShift);
...
int  copy_image_to_framebuffer(char *pcFramebufferDev, const void *pvDataGREY_OR_R, const void *pvDataGREY_OR_G, const void *pvDataGREY_OR_B, U32 dy, U32 pitch)
{
	...
	if(fbufVars.bits_per_pixel == 16) {
				for(y = 0; y < min(fbufVars.yres, dy); y++)
		{
			...
			for(x = 0; x < min(fbufVars.xres, pitch); x++)
			{
				*((U16*) pOut) = (((*pInR) >> 3) << 11) | (((*pInG) >> 2) << 5) | (((*pInB) >> 3) << 0);
...
I32  convert_srggb10_and_debayer_image(image *imgOut, char *bufIn, U32 pixelformat, I32 v4lDx, I32 v4lDy, I32 v4lPitch, I32 maxBits, int bitShift)
{
	...
	rc =  convert_16bit_to_image(&imgU8,  bufIn, v4lDx, v4lDy, v4lPitch, maxBits, bitShift);
	if(rc<0){ee=-2+10*rc; goto fail;}
